...
NGame = {
	...
	ENERGY_RESOURCE = "",						-- resource that will give country energy 
...
NDiplomacy = {
	...
	VOLUNTEERS_PER_TARGET_PROVINCE = 0.25,			-- Each province owned by the target country contributes this amount of volunteers to the limit.
	...
	VOLUNTEERS_TRANSFER_SPEED = 6,					-- days to transfer a unit to another nation
...
NProduction = {
	...
	RESOURCE_TO_ENERGY_COEFFICIENT = 100.0,		-- How much energy per coal produces
	...
	BASE_ENERGY_COST = 0.0,						-- How much energy per factory consumes
	ENERGY_COST_CAP = 0,						-- Maximum energy cost per factory
	ENERGY_SCALE_PER_TRADE_FACTORY_EXPORT = 0.0, -- Factor of how many of the factories gained from trade is affects the energy cost scaling
...
NBuildings = {
	...
	INFRASTRUCTURE_RESOURCE_BONUS = 0.02, -- multiplicative resource bonus for each level of (non damaged) infrastructure
...
NMilitary = {
	...
	NUKE_DELAY_HOURS = 1,							-- How many hours does it take for the nuclear drop to happen
	PARADROP_PENALTY = -0.12, 						-- Combat penalty when recently paradropped
...
NAI = {
	...
	NUM_FACTORIES_IN_STATE_TO_WANT_ENERGY_REDUCTION = 0,			-- How many mils should we want in a state before we think about building energy reduction cap building
