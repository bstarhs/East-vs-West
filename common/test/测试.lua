...
NGame = {
	...
	FUEL_RESOURCE = "no",							-- resource that will give country fuel
...
NDiplomacy = {
	...
	IDEOLOGY_JOIN_FACTION_MIN_LEVEL = 0.9,			-- ideology limit required to join faction
	JOIN_FACTION_LIMIT_CHANGE_AT_WAR = 0.9,			-- if in defensive war this or your modifier is counted as limit to join factions (so if you have 80% join limit this now means you can join at 50%)
	...
	ASSUME_FACTION_LEADERSHIP_PP_COST = 500,				-- Political power cost to assume faction leadership
...
NCountry = {
	...
	RESISTANCE_STRENGTH_FROM_NEIGHBORS = 0.1, 		-- Multiplies how much resistance can spread from one state to its neighbors, a state will spread whatever is highest of its victorypoints resistance increase or half of any of its neighbors spread, multiplied by this
	...
	NUCLEAR_PRODUCTION_SCALE = 180,					-- +1 nuclear_production gives 1 nuke per year
	...
	POLITICAL_POWER_UPPER_CAP = 6000.0,				-- Max amount of political power country should have
	RESISTANCE_IMPORTANT_LEVEL = 0.4,				-- Level when resistance becomes dangerous
	RESISTANCE_IMPORTANT_COUNTRY_LEVEL = 0.3,		-- Level when average resistance in a country becomes dangerous
	...
	GIE_EXILE_TROOPS_DEPLOY_TRAINING_MAX_LEVEL = 1, 	--Max XP exile troops can receive from training
...
NResistance = {
	INITIAL_STATE_RESISTANCE = 2.0,							-- initial resistance percentage of a state once it is captured
	...
	RESISTANCE_COOLDOWN_WHEN_DISABLED = -0.3,				-- resistance cooldown when the state is taken back by its original owner (compliance is zeroed in that case)

	RESISTANCE_TARGET_BASE = 5.0,							-- base resistance target percentage

	RESISTANCE_TARGET_MODIFIER_HAS_CLAIM = -2.0,			-- resistance target modifier in % for states we have claim
	...
	RESISTANCE_TARGET_MODIFIER_POP_LOW = -30.0,			-- how much we reduce the resistance target
	RESISTANCE_TARGET_MODIFIER_POP_VERY_LOW = -20.0,			-- resistance target modifier in % for states we have claim
	...
	RESISTANCE_DECAY_MODIFIER_HAS_CLAIM = 30.0, -- resistance decay modifier for our claims
...
NProduction = {
	...
	ANNEX_STOCKPILES_RATIO = 4.0,		-- How much stockpiled equipment will be transferred on annexation
	ANNEX_FIELD_EQUIPMENT_RATIO = 0.4,	-- How much equipment from deployed divisions will be transferred on annexation
	ANNEX_FUEL_RATIO = 0.3,	-- How much fuel will be transferred on annexation
	...
	PRODUCTION_RESOURCE_LACK_PENALTY = -0.08,			-- Penalty decrease while lack of resource per factory
...
NBuildings = {
	...
	INFRASTRUCTURE_RESOURCE_BONUS = 0.05, -- multiplicative resource bonus for each level of (non damaged) infrastructure
...
NMilitary = {
	...
	EXPERIENCE_LOSS_FACTOR = 1.20,                 -- percentage of experienced solders who die when manpower is removed
	...
	TRAINING_MIN_STRENGTH = 0.4,					-- if strength is less than this, the unit will pause training until it's been reinforced
	TRAINING_MAX_DAILY_COUNTRY_EXP = 0.05,			-- Maximum army XP gained per day from training
...
NAir = {
	...
	TOP_SPEED_DAMAGE_BONUS_FACTOR = 0.025,				-- A factor for scaling the top speed of a plane into damage buff. If a
	...
	CLOSE_AIR_SUPPORT_EXPERIENCE_SCALE = 0.005,			-- How much the experinence gained by CAS is scaled
	PARADROP_EXPERIENCE_SCALE = 0.03,					-- How much the experinence gained by paradropping is scaled
	BOMBING_DAMAGE_EXPERIENCE_SCALE = 0.002,           -- How much the experinence gained by bombing is scaled
	...
	STRATEGIC_BOMBER_NUKE_AIR_SUPERIORITY = 1.5,		-- How much air superiority is needed for a tactical bomber to be able to nuke a province
	...
	LEND_LEASED_EQUIPMENT_EXPERIENCE_GAIN = 0.3,		-- Value used for equipment
...
NNavy = {
	...
	UNIT_EXPERIENCE_PER_COMBAT_HOUR = 6,
	...
	TRAINING_EXPERIENCE_FACTOR = 0.2,								-- Amount of exp each ship gain every 24h while training (before modifiers)
	...
	TRAINING_ORG = 0.3,												-- max organization on traiaing mission
...
NAI = {
	...
	DIPLOMACY_CREATE_FACTION_FACTOR = 0.1,		-- Factor for AI desire to create a new faction. Val < 1.0 makes it less likely to create than to join.
	DIPLOMACY_FACTION_WRONG_IDEOLOGY_PENALTY = 30, -- AI penalty for diplomatic faction acitons between nations of different ideologies
	...
	DIPLOMACY_FACTION_GLOBAL_TENSION_FACTOR = 0.6,-- How much the AI takes global tension into account when considering faction actions
	...
	DIPLOMACY_SCARED_MINOR_EXTRA_RELUCTANCE = -80, -- extra reluctance to join stuff as scared minor
	DIPLOMACY_FACTION_PLAYER_JOIN = 5,			-- Bonus for human players asking to join a faction.
	...
	DIPLOMACY_FACTION_MAJOR_AT_WAR = 100.0,	-- Factor that will be multiplied with the surrender level in the desire to offer to the other ai to join a faction
	DIPLOMACY_FACTION_SURRENDER_LEVEL = 20, 	-- How much the recipient nation losing matters for joining a faction
	DIPLO_PREFER_OTHER_FACTION = -800,			-- The country has yet to ask some other faction it would prefer to be a part of.
	...
	FASCISTS_BEFRIEND_DEMOCRACIES = -20,
	FASCISTS_BEFRIEND_COMMUNISTS = -30,
	FASCISTS_ALLY_FASCISTS = 10,
	FASCISTS_ALLY_DEMOCRACIES = -50,
	FASCISTS_ALLY_COMMUNISTS = -60,
	FASCISTS_ANTAGONIZE_FASCISTS = 0,
	FASCISTS_ANTAGONIZE_DEMOCRACIES = 20,
	FASCISTS_ANTAGONIZE_COMMUNISTS = 50,
	DEMOCRACIES_BEFRIEND_FASCISTS = -50,
	DEMOCRACIES_BEFRIEND_DEMOCRACIES = 20,
	DEMOCRACIES_BEFRIEND_COMMUNISTS = 5,
	DEMOCRACIES_ALLY_FASCISTS = -100,
	DEMOCRACIES_ALLY_DEMOCRACIES = 20,
	DEMOCRACIES_ALLY_COMMUNISTS = -10,
	DEMOCRACIES_ANTAGONIZE_FASCISTS = 50,
	DEMOCRACIES_ANTAGONIZE_DEMOCRACIES = -50,
	DEMOCRACIES_ANTAGONIZE_COMMUNISTS = 0,
	COMMUNISTS_BEFRIEND_FASCISTS = -50,
	COMMUNISTS_BEFRIEND_DEMOCRACIES = 5,
	COMMUNISTS_BEFRIEND_COMMUNISTS = 40,
	COMMUNISTS_ALLY_FASCISTS = -100,
	COMMUNISTS_ALLY_DEMOCRACIES = -50,
	COMMUNISTS_ALLY_COMMUNISTS = 20,
	...
	START_TRAINING_EQUIPMENT_LEVEL = 0.80,               -- ai will not start to train if equipment drops below this level
	...
	NAVAL_MIN_EXCORT_PLANES = 0,						-- Min amount of planes requested to excort operations = 0,							-- Min amount of airwings requested to excort operations
	...
	LAND_COMBAT_CAS_PLANES_PER_ENEMY_ARMY_LIMIT = 4,		-- Limit of CAS wings requested by enemy armies
	...
	LAND_COMBAT_BOMBERS_PER_LAND_FORT_LEVEL = 8,		-- Amount of bomber planes requested per enemy land fort level
	LAND_COMBAT_BOMBERS_PER_COASTAL_FORT_LEVEL = 8,	-- Amount of bomber planes requested per enemy coastal fort level
	...
	CARRIER_TASKFORCE_MAX_CARRIER_COUNT = 5, 		-- optimum carrier count for carrier taskforces
	...
	SUB_TASKFORCE_MAX_SHIP_COUNT = 20 ,				-- optimum sub count for sub taskforces
...
NOperatives = {
	...
	AGENCY_UPGRADE_PER_OPERATIVE_SLOT = 3,			-- Number of upgrade needed to unlock an additional operative slot
	MAX_OPERATIVE_SLOT_FROM_AGENCY_UPGRADES = 3,	-- max operative slots gained from upgrades
	AGENCY_OPERATIVE_RECRUITMENT_TIME = 5,			-- Number of days to wait to have operative to recruit when an operative slot first becomes available
...
NIntel = {
	...
	RADAR_LEVEL_INTEL_FACTOR = 1.5,					-- Multiplied to the radar level to tell the fraction of intel per covered province we get. The radar level is computed as BuildingLevel / MaxBuildingLevel.
